...
namespace ExpanseTracker.Controllers
{
    public class ExpanseCategoryController : Controller
    {
        ...
        // GET: ExpanseCategorie/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ExpanseCategorie/Create
        ...
        // POST: ExpanseCategorie/Delete/5
